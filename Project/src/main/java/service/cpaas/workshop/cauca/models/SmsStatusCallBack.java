 ...
 */
package service.cpaas.workshop.cauca.models;
...
public class SmsStatusCallBack {
    ...
    public String toString() {
        return "SmsStatusCallBack{" + "accountSid=" + accountSid + ", apiVersion=" + apiVersion + ", body=" + body + ", dirstatus=" + dirstatus + ", errorMessage=" + errorMessage + ", from=" + from + ", price=" + price + ", smsSid=" + smsSid + ", smsStatus=" + smsStatus + ", to=" + to + '}';
    }
